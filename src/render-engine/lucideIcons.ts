...
// per concept — the Spark block below came with the engine; the Linux block came with the scaffold
// copy and stays until the Data Warehousing scenes settle their own glyph set.
...
import {
  ...
  BarChart3, ChartPie, Star, Snowflake, CalendarDays, Ruler, History,
  GitMerge, Warehouse, Package, ArrowDownUp, Trash2, ListTree, Fingerprint,
  type LucideIcon,
} from 'lucide-react'
