...
const ALL: Scene[] = [...foundationsScenes, ...keysScenes, ...factsScenes, ...dimensionsScenes, ...schemasScenes, ...historyScenes, ...datavaultScenes, ...designScenes, ...loadingScenes, ...platformScenes]
